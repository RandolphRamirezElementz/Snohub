...
class OnboardingStepThree: OnboardingStepOne {

    override var image_key:String { get { return "onboarding_step_3" } }
    override var step_key:String  { get { return "3" } }
...
//            ]
//            
//            dataManager.postFormData(parameters: parameters, urlstring: "/users/registerDriver/3", completionCallback: { (success, message) in
//                
//                DispatchQueue.main.async(execute: {
...
//                        dataManager.onboarding_info["3"] = ["step_status":"PASSED"]
//                        self.goToNextStep()
//                    })
//                }
//                else
...
//            })
    ...
    override func goToNextStep(){
        ...
        {
            self.performSegue(withIdentifier: "goToSummaryFromStep3", sender: self)
        }
        else
        {
            //self.performSegue(withIdentifier: "goToStep4", sender:self)
