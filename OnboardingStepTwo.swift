...
class OnboardingStepTwo: OnboardingStepOne {

    override var image_key:String { get { return "onboarding_step_2" } }
    override var step_key:String  { get { return "2" } }
    /*
    // MARK: - Navigation
...
//            ]
//            
//            dataManager.postFormData(parameters: parameters, urlstring: "/users/registerDriver/2", completionCallback: { (success, message) in
//                
//                DispatchQueue.main.async(execute: {
...
//                        dataManager.onboarding_info["2"] = ["step_status":"PASSED"]
//                        self.goToNextStep()
//                    })
//                }
//                else
...
//            })
    ...
    override func goToNextStep(){
        ...
        {
            self.performSegue(withIdentifier: "goToSummaryFromStep2", sender: self)
        }
        else
        {
