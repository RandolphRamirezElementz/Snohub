...
class SettingsViewController: UITableViewController {
    var settings: Settings {
        return Settings(theme: self.theme.stpTheme,
                        ...
                        additionalPaymentMethods: .applePay,
    ...
    private var theme: Theme = .CustomDark
    ...
    fileprivate enum Theme: String {
        ...
        var stpTheme: STPTheme {
            ...
            case .CustomDark:
                let theme = STPTheme()
                theme.primaryBackgroundColor = UIColor(red:(7.0/255.0), green:(66.0/255.0), blue:(129.0/255.0), alpha:1.00)
                theme.secondaryBackgroundColor = UIColor(red:(11.0/255.0), green:(92.0/255.0), blue:(198.0/255.0), alpha:1.00)
                theme.primaryForegroundColor = UIColor(red:1.00, green:1.00, blue:1.00, alpha:1.00)
                theme.secondaryForegroundColor = UIColor(red:(146.0/255.0), green:(187.0/255.0), blue:(213.0/255.0), alpha:1.00)
                theme.accentColor = UIColor(red:1.0, green:(87.0/255.0), blue:0.0, alpha:1.00)
